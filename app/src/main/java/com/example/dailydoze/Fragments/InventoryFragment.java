...
public class InventoryFragment extends Fragment {
    ...
    private List<InventoryModel> myInvModels = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                    ...
                    if (medicationDetails != null && !medicationDetails.isEmpty()) {
                        for (MedicationSchema medication : medicationDetails) {
                                    ...
                                    InventoryModel invModel = new InventoryModel(
                                            ...
                                            (int)(medication.getMedQuantity()/medication.getMedDaily())+"",
                                            medication.get_id(),
                                            medication.getMedType()
                                    );
                                    myInvModels.add(invModel);
        ...
        adapter = new InventoryAdapter(myInvModels, getContext());
